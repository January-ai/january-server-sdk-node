...
export const schemas: Record<string, Schema> = {
  ...
  "CreditBalance": {
    ...
    "properties": {
      ...
      "resets_at": {
        "description": "When the billing period ends and the next begins: `used_credits` and the free-call count return to 0 and the request allowance reopens.",
        "type": "string",
        "format": "date-time",
        "publicName": "resetsAt"
      },
      ...
      "used_credits": {
        "description": "Credits used so far this period. Each successful call costs the credits on the price list; failed calls cost nothing.",
        "type": "integer",
